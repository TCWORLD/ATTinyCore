###### Arduino 1.6.4+ core for ATTiny's
To install just add this URL to your board manager: https://github.com/FemtoCow/ATTinyCore/raw/master/Download/package_femtocow_attiny_index.json
